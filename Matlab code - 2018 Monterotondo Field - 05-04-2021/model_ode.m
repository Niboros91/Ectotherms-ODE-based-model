...
Temp_avg = csvread('TemperaturesF2.csv', 1);
...
for t=1:(Simulation_time-1) %Loop for the simulation
    ...
    %We recompute A based on the new temperature (like before)
...
valid_1 = csvread('ValidField2.csv', 1);
...
ylim([0 315])
title('Monterotondo Field 2018','Fontsize',20);
set(gca,'FontSize',15)
