...
%% PLOTS
t1 = datetime(2019,4,18,12,0,0);
t=t1+days(0:Simulation_time-1);
tt_0 = 1:Simulation_time; %Set the day zero for the simulations in respect of the field data
tt = tt_0+37;


% Plot of all population development
...
hold on
scatter(t(valid_1(:,1)-37),valid_1(:,2),'LineWidth',2)
hold on
plot(t(valid_1(:,1)-37),valid_1(:,2),":",'LineWidth',1.5)
legend("Adult males", "Field data",'Fontsize',15);
xlabel('time (days)','Fontsize',15);
ylabel('Number of adult males','Fontsize',15);
title('Monterotondo Field 2019','Fontsize',20);
set(gca,'FontSize',15)
